        ...
        <div class="card bg-base-100 shadow">
            <div class="card-body p-8">
                <div class="flex flex-wrap items-center gap-8">
                    ...
                    <select
                        v-model="sort"
                        class="select select-bordered h-10 min-w-[120px] bg-base-100"
                    >
                    ...
                    <select
                        v-model="dir"
                        class="select select-bordered h-10 min-w-[100px] bg-base-100"
                    >
            ...
            <div class="card-body p-8">
                <div class="overflow-x-auto">
                    <table class="table table-zebra table-lg w-full">
                        <thead>
                            <tr>
                                <th class="whitespace-nowrap min-w-[8rem]">
                                    Nome
                                </th>
                                <th class="whitespace-nowrap min-w-[12rem]">
                                    Email
                                </th>
                                <th class="whitespace-nowrap min-w-[10rem]">
                                    Role
                                </th>
                                <th class="whitespace-nowrap min-w-[12rem]">
                                    Ações
...
async function updateRole(user, event) {
    ...
    try {
        await window.axios.patch(`/api/users/${user.id}/role`, {
            role: newRole,
        });
        user.role = newRole;
        if (window.showToast) {
