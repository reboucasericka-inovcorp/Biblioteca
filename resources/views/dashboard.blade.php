    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <!-- Total Books -->
                <a href="{{ route('books.index') }}" class="card bg-base-100 shadow-md hover:shadow-lg transition-shadow">
                    <div class="card-body p-6">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 rounded-md p-3 bg-info">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-2xl font-semibold text-base-content">{{ $booksCount }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Total Authors -->
                <a href="{{ route('authors.index') }}" class="card bg-base-100 shadow-md hover:shadow-lg transition-shadow">
                    <div class="card-body p-6">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 rounded-md p-3 bg-success">
                                <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-base-content/70 truncate">Total Authors</dt>
                                    <dd class="text-2xl font-semibold text-base-content">{{ $authorsCount }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Total Publishers -->
                <a href="{{ route('publishers.index') }}" class="card bg-base-100 shadow-md hover:shadow-lg transition-shadow">
                    <div class="card-body p-6">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 rounded-md p-3 bg-secondary">
                                <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-base-content/70 truncate">Total Publishers</dt>
                                    <dd class="text-2xl font-semibold text-base-content">{{ $publishersCount }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
