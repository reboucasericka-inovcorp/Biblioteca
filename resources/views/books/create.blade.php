                    ...
                    <form method="POST" action="{{ route('books.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="rounded border-steel-gray text-electric-blue focus:ring-electric-blue">
                        ...
                        <div class="mt-4">
                            ...
                            <input id="file" type="file" name="file" accept="application/pdf" class="block mt-1 w-full">
                            <p class="text-sm text-night-blue/70 mt-1">Máx. 20 MB. Apenas ficheiros PDF.</p>
                        </div>
