        ...
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('users.update', $user) }}">
                ...
                <div class="space-y-4 max-w-xl">
                    ...
                    <div>
                        <x-label for="password" value="Nova palavra-passe (deixar em branco para manter)" />
                    ...
                    <div>
                        ...
                        <select id="role" name="role" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500" required>
                            @php
                                $currentRole = $user->roles->first()?->name ?? 'Cidadao';
                            @endphp
                            <option value="Cidadao" {{ old('role', $currentRole) === 'Cidadao' ? 'selected' : '' }}>Cidadão</option>
